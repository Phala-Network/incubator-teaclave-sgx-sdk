...
fn main() {
    // nightly-2021-05-12 (rustc 2021-05-11)
    // https://github.com/rust-lang/rust/commit/506e75cbf8cb5305e49a41326307004ca3976029
    if let Some(true) = is_min_date("2021-05-12") {
        println!("cargo:rustc-cfg=enable_const_fn");
    }
}
